//CarpetInstallantionQuote.java

import java.util.ArrayList;
import java.util.Scanner;

public class CarpetInstallationQuote 
{
	/** This program generates a quote based on room dimension input by user */ 
		...
		do
		{
			...
			switch (selection)
			{
				...
				case 1:				//Square
					...
					areaPerRoom[count] = Area.calcSquareArea(dimensions[0], dimensions[1]);	
					break;
				case 2:				//Rectangle
					readQuoteParameters(keyboard, selection, shapes, dimensions, quote);
					areaPerRoom[count] = Area.calcRectangleArea(dimensions[0], dimensions[1]);	
					break;
				case 3:				//Triangle
					readQuoteParameters(keyboard, selection, shapes, dimensions, quote);
					areaPerRoom[count] = Area.calcTriangleArea(dimensions[0], dimensions[1]);
					break;
				case 4:				//Circle
					readQuoteParameters(keyboard, selection, shapes, dimensions, quote);			
					areaPerRoom[count] = Area.calcCircleArea(dimensions[0]);	
					break;
				case 5:				//Trapezoid
					readQuoteParameters(keyboard, selection, shapes, dimensions, quote);
					areaPerRoom[count] = Area.calcTrapezoidArea(dimensions[0], dimensions[1], dimensions[2]);
					break;
				case 6:				//Parallelogram
					readQuoteParameters(keyboard, selection, shapes, dimensions, quote);
					areaPerRoom[count] = Area.calcParallelogramArea(dimensions[0], dimensions[1]);
					break;
				default:
